            ...
            <div class="gridster flex-grow-1">
                <ul>
                    <li data-row="1" data-col="1" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="2" data-col="1" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="3" data-col="1" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>

                    <li data-row="1" data-col="2" data-sizex="2"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="2" data-col="2" data-sizex="2"
                        data-sizey="2">@include('_widgets.widget_placeholder')</li>

                    <li data-row="1" data-col="4" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="2" data-col="4" data-sizex="2"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="3" data-col="4" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>

                    <li data-row="1" data-col="5" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="3" data-col="5" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>

                    <li data-row="1" data-col="6" data-sizex="1"
                        data-sizey="1">@include('_widgets.widget_placeholder')</li>
                    <li data-row="2" data-col="12" data-sizex="1"
                        data-sizey="2">@include('_widgets.widget_placeholder')</li>
                </ul>
            </div>
        </div>
