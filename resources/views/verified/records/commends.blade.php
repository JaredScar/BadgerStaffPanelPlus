    ...
    <body class="background-sizing gta-bg1">
        ...
        <script>
            ...
            document.getElementById('addCommendForm').addEventListener('submit', function(e) {
                ...
                // Validate form
                if (selectedPlayers.length === 0) {
                    alert('Please select at least one player to commend.');
                    return;
                }
                
                if (!type || !reason.trim()) {
                    alert('Please fill in commend type and reason fields.');
                    return;
                }
                
                // Here you would typically send the data to your backend
                console.log('Adding commend records for players:', { 
                ...
                alert(`Commendation issued successfully to ${playerCount} player(s): ${playerNames}`);
                
                bootstrap.Modal.getInstance(document.getElementById('addCommendModal')).hide();
