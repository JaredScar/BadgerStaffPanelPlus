    ...
    <body class="background-sizing gta-bg1">
        ...
        <script>
            ...
            document.getElementById('addBanForm').addEventListener('submit', function(e) {
                ...
                // Validate form
                if (selectedPlayers.length === 0) {
                    alert('Please select at least one player to ban.');
                    return;
                }
                
                if (!duration || !reason.trim()) {
                    alert('Please fill in duration and reason fields.');
                    return;
                }
                
                // Here you would typically send the data to your backend
                console.log('Adding ban records for players:', { 
                ...
                alert(`Ban issued successfully to ${playerCount} player(s): ${playerNames}`);
